...
import java.io.{FileOutputStream, DataOutputStream, ByteArrayOutputStream}
...
object SpeechSamples {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println("Testing with a speech-like modulated tone (200Hz base + 50Hz mod) - should be more interesting for Whisper")
