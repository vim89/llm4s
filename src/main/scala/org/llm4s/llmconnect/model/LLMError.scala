...
@deprecated("Use org.llm4s.error.AuthenticationError instead", "0.1.1")
case class AuthenticationError(message: String) extends LLMError

@deprecated("Use org.llm4s.error.RateLimitError instead", "0.1.1")
case class RateLimitError(message: String) extends LLMError

@deprecated("Use org.llm4s.error.ServiceError instead", "0.1.1")
case class ServiceError(message: String, code: Int) extends LLMError

@deprecated("Use org.llm4s.error.ValidationError instead", "0.1.1")
case class ValidationError(message: String) extends LLMError

@deprecated("Use org.llm4s.error.UnknownError instead", "0.1.1")
